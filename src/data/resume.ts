// Background data: education & professional experience.
// Extracted verbatim from the original ResumeSection (v1) — do not trim content.
...
export interface ResumeProject {
  ...
  url?: string;
  /**
   * Links this entry to a case in projects.ts. Non-featured cases render their
   * insight and figures here instead of as a card; featured ones just link up
   * to the full study, so nothing is written twice.
   */
  projectId?: string;
}
...
export const getSummary = (language: Lang) => ({
...
export const getResumeIntro = (language: Lang): string =>
  language === 'en'
...
export const getEducation = (language: Lang): ResumeItemData[] => [
    {
    ...
    {
      title: language === 'en' ? "UX/UI Design (70 h)" : "Diseño UX/UI (70 h)",
      period: "2025",
      location: "UTN Facultad Regional Mendoza & Escuela de Programación de Godoy Cruz",
      description: language === 'en'
    ...
    {
      title: language === 'en' ? "Full-Stack Web Development (600 h)" : "Programación Web Full Stack (600 h)",
      period: "2022 - 2023",
...
export const getExperience = (language: Lang): ResumeItemData[] => [
    {
      title: language === 'en' ? "UX Designer" : "Diseñador UX",
    ...
    },
    {
      ...
      period: "2025 - 2026",
      location: "Casa del Futuro, Mendoza",
      description: language === 'en'
        ? "UX for GotApp, a civic water-services application built with the Casa del Futuro programme (Government of Mendoza) and still in active development. Owned the product experience end to end: user research, information architecture, user flows, wireframes and high-fidelity prototypes in Figma, plus accessibility-first responsive interfaces and a published interactive prototype covering the complete user flow."
        : "UX de GotApp, una aplicación ciudadana de servicios hídricos construida con el programa Casa del Futuro (Gobierno de Mendoza) y todavía en desarrollo activo. Responsable de la experiencia del producto de punta a punta: investigación de usuarios, arquitectura de información, user flows, wireframes y prototipos de alta fidelidad en Figma, además de interfaces responsive con foco en accesibilidad y un prototipo interactivo publicado que cubre todo el flujo."
    },
    {
      title: "AI Tasker",
      period: "2024 - 2025",
    ...
    },
    {
      ...
      projects: [
        {
          title: language === 'en'
            ? "Trekk Mates (self-initiated)"
            : "Trekk Mates (proyecto propio)",
          projectId: 'trekk-mates',
          description: language === 'en'
            ? "Self-initiated concept project: a hiking partner app pairing guided navigation with social matching, designed around trust and reassurance rather than raw route data."
            : "Proyecto conceptual propio: una app de compañeros de senderismo que combina navegación guiada con matching social, diseñada alrededor de la confianza y no del dato crudo de la ruta.",
