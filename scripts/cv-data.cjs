  ...
  experience: [
    {
      ...
      bullets: [
        ...
        'Designed AXIA, Farmacia.AI, aegle and VEYRA — AI backoffices for insurance, pharmacy, hospitality and logistics — as instances of one product system, including a drag-and-drop report builder that lets an operator compose a pivot query without writing SQL.',
  ...
  experience: [
    {
      ...
      bullets: [
        ...
        'Diseñé AXIA, Farmacia.AI, aegle y VEYRA — backoffices con IA para seguros, farmacia, hotelería y logística — como instancias de un mismo sistema de producto, incluyendo un constructor de informes por arrastre que permite armar una consulta pivot sin escribir SQL.',
